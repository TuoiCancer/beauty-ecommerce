export const listProduct = [
	{
		...
		inventory: 10,
		description:
			'Helps control oil, tightens poresSoothes swollen acne, inflamed pimples, and prevents whiteheadsAnti-aging and brightening, helps the skin become firm, plump, and softOrigin: Canada',
...
export const listCategory = [
	...
	},
	{
		...
		title: 'Facial',
		description: 'Caused by seasonal changes, allergies, excessive hand washing'
	},
	{
		id: 3,
